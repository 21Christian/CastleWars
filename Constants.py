...
# Worker
WORKER_COST = 10    # amount of resources to train a new worker
WORKER_TRAIN = 10  # amount of turns to train a new worker
WORKER_SPEED = 1.5  # distance covered in one turn by a running worker
WORKER_PROD = 100    # amount of resources per turn mined by a worker in mine
WORKER_REPAIR = 3  # amount of HP restored per turn by a worker in wall

# Swordsman
SWORD_COST = 40    # amount of resources to train a new swordsman
...
SWORD_HEALTH = 50  # initial amount of HP of a swordsman

# Archer
ARCHER_COST = 50    # amount of resources to train a new archer
ARCHER_TRAIN = 20  # amount of turns to train a new archer
ARCHER_SPEED = 3  # distance covered in one turn by a running archer
...
ARCHER_HEALTH = 30  # initial amount of HP of an archer
ARCHER_HIT = 3     # damage caused by of an arrow shoot by an archer
